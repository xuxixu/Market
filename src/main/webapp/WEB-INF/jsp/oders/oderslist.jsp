...
<script type="text/javascript">
	...
	function toPage(pageIndex)
	{
	    ...
	    $("#userform").attr("action", "${ctx}/findUser.do");
		$("#userform").submit();
	}
 	   ...
 	   $("#delete").click(function(){
 		   ...
 		   if(checkedBoxs.length < 1){
 			   alert("请选择一个需要删除的用户！");
 			    ...
 			    $("#userform").attr("action", "${ctx}/userdel.do");
 		 		$("#userform").submit();
 		   }
 	   })
...
<body>
	...
	<form name="userform" class="form-inline" method="post" id="userform"
		action="${ctx}/findUser.do">
						...
						<tr>
							<td class="fftd">
								...
								性别:<select name="sex" class="form-control">
									...
									手机号:<input name="phone" class="form-control"
										value="${use.phone }">
						...
						<c:forEach items="${pageModel.list }" var="user" varStatus="stat">
							<tr id="data_${stat.index}" align="center" class="main_trbg">
								...
								<td align="center" width="40px;"><a
									href="${ctx}/editUser.do?uid=${user.uid}"> <img title="修改"
