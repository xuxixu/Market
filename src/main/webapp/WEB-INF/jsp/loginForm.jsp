	...
	<div class="page-lock">
		<div class="page-logo" style="margin-bottom: 2px">
			<a class="brand" href="login.html"
				style="font-size: 22px; color: #FFF;"><font color="#FFCC00">便利店销售管理</font><span
		...
		<form action="${ctx}/login.do" method="post" id="loginForm">
						...
						<div class="controls">
							<div class="input-icon left">
								<i class="icon-user"></i> <input
									...
									id="loginname" name="number" value="${number}">
							</div>
						</div>
					</div>
					<div class="control-group">
			...
			<div class="page-footer" style="color: #fff">
				兼容浏览器IE8+，最佳分辨率1280*800. <br>2020 @ 粤嵌 http://www.gec-edu.org/?bdqpx
			</div>
		</form>
	</div>
	<script
